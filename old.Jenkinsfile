pipeline {
	...
	parameters {
		string(name: 'PowerBI_Apps',    defaultValue: 'CAS',                                              description: 'Application Apps')
		string(name: 'PowerBI_Env',     defaultValue: 'KH_REP_SIT02_EDB',                                description: 'Power BI Environment')
		string(name: 'Group_ID_Env',    defaultValue: '0151d1cb-6b70-44b9-827a-41534cfa26e7',            description: 'Workspace Group ID')

		// ODBC connection replacement inside the RDL file only
		string(name: 'Find_String',     defaultValue: 'kh_edb_v09',                                      description: 'ODBC connection text to find in RDL')
		string(name: 'Replace_String',  defaultValue: 'KH_REP_SIT02_EDB',                                description: 'ODBC connection text to replace in RDL')

		string(name: 'PowerBI_Repo_URL', defaultValue: 'git@github.com:mfc-cambodia/pbi2.0-kh-cas.git', description: 'Git repository URL')
		string(name: 'Git_Branch',       defaultValue: 'release/2.0',                                    description: 'Git branch or tag')
		string(name: 'Mail_Builder',     defaultValue: 'try_chenhai@manulife.com',                       description: 'Notification email recipient')
